    ...
    const obj = {
        ...
        drawData () {
            ...
            for (let i = 0; i < arrData.length; i += incDBDataIdx) {
                ...
                //pathP.lineTo(mX + dxVLine * inc, mY - ((arrData[i].p) / 1000) * mH);
                pathP.lineTo(mX + dxVLine * inc, mY - ((arrData[i].p - 700) / 100) * mH);
                pathHg.lineTo(mX + dxVLine * inc, mY - ((arrData[i].h) / 100) * mH);


                //console.log('arrData ' + i + ' ' + arrData[i].temp + ' ' + arrData[i].p + ' ' + arrData[i].hg);
            ...
            if (options.t.bDraw === true) {
                ...
                //console.log('draw T' + options.t.clr);
            }
            ...
            if (options.p.bDraw === true) {
                ...
                //console.log('draw P' + options.p.clr);
            }
            if (options.h.bDraw === true) {
                mCtx.strokeStyle = options.h.clr;
                mCtx.stroke(pathHg);

                //console.log('draw H' + options.h.clr);
            }
            mCtx.restore();
        }
    }
